...
public class TTS_11_Labs : MonoBehaviour
{
    ...
    private string[,] voices = new string[,]
    {
        ...
        {"Juvy", "sfEqHIAPrP82grzla9Ji" }
    };

    private enum SelectVoices { Aria, Roger, Sarah, Laura, Charlie, George, Callum, River, Liam, Charlot, Alice, Matilda, Will, Jessica, Eric, Chris, Brian, Daniel, Lily, Bill, Juvy }
